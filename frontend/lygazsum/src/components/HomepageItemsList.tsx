  ...
  return (
    <li>
      <Link to={`/detailedGazette/${gazetteItem.id}`}>
        <div className="flex flex-col justify-center mx-auto w-11/12 md:w-4/5 px-4 py-4 md:px-8 md:py-8 border-2 rounded-3xl border-neutral-200 hover:border-neutral-500 bg-white">
          ...
          <p className="text-neutral-600 leading-relaxed line-clamp-2 md:line-clamp-3">
